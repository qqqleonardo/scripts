...
[rewrite_local]
^https:\/\/member\.guoyuejiu\.com\/api\/coupon\/list\/recommend url script-request-header https://raw.githubusercontent.com/qqqleonardo/scripts/refs/heads/main/YSHY.js
...
const GLJJ = ($.isNode() ? JSON.parse(process.env.YSHY) : $.getdata("YSHY")) || [];
let notice = ''
!(async () => {
